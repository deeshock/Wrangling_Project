...
german1%>%
  ...
  xlab("date_bombered") + ylab("Number") + theme(legend.position = "none")
```
...
a111 <- a111%>%str_extract_all("[0-9]+")
for (i in 1:25) {
  a111[[i]] <- a111[[i]][1]%>%str_join(a111[[i]][2])
}
a1111 <- rep(0,25)
for (i in 1:25) {
  a1111[i] <- a111[[i]][1]
}
city_dense$`2015 population density` <-a11111
